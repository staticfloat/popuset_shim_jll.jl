...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import popuset_shim_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cda8bdfc-82c4-5e04-8e46-2d351740fb6c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "popuset_shim", artifacts_toml) for e in artifacts["popuset_shim"]]
...
if best_platform === nothing
    @debug("Unable to load popuset_shim; unsupported platform $(triplet(platform_key_abi()))")
else
